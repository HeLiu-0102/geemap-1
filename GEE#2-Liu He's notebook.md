...
所以它把谷歌引擎的所有分析功能都带进了I pee while deflect。
...
![2.2](C:\Users\hp\Desktop\2.2.png)

![2.3](C:\Users\hp\Desktop\2.3.png)
...
and now you have all the base map here you can have a job down this that you can select the base map 
...
所以首先我要拿这个，你可以选择任何一个地下室，你喜欢这个，现在这里有62个地下室，没有，比如nao市国家土地覆盖数据库
...
so there are two functions available in here so at WMS so WMS stands for web map service and all we need is a link and

所以这里有两个功能，所以在WMS，WMS代表web地图服务，我们只需要一个链接和

then the name of the layer you can also add X Y Z type maps to the map so for example we can simply copy and copy this one 

然后图层的名称，你也可以添加X Y Z类型的地图到地图上，例如，我们可以简单地复制和复制这个
